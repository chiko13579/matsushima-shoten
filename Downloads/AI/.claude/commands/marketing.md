...
### STEP1: ターゲット分析
ターゲット情報を元に5〜10パターンのターゲット像を分析する。

### STEP2: 訴求コンセプト生成
商品アイデア草案を元に10個以上のコンセプトを生成する。
...
### STEP5: 興味づけタイトル
`01_興味づけコツ.md` の黄金公式（6欲求 × 9フック）を適用して5パターン生成する。
...
### STEP7: 見込み客の教育戦略
7日間の教育スケジュールと各日のコンテンツ案を生成する。

### STEP8: セミナー構成案
セミナー構成案コツを参照してセミナー全体の流れを設計する。
